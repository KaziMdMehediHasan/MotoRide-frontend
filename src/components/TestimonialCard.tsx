...
const TestimonialCard = ({ avatar, quote, name, location, date, rating }: TestimonialProps) => {
    return (
        <div className="w-96 rounded-xl overflow-hidden shadow-xl border border-teal-400 bg-gray-50 p-6 m-4">
