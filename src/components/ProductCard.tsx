    ...
    return (
        <>
            <Link to={isHomePage ? `bikes/bike/${_id}` : `bike/${_id}`}>
                <div key={_id} className="border border-teal-400 w-80 2xl:w-80 rounded-lg p-4 relative bg-gray-50 shadow-xl justify-self-center hover:scale-105 hover:shadow-2xl cursor-pointer transition-all duration-300 xl:w-[18rem]">
                    {
