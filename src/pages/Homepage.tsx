    ...
    return (
        <>
            ...
            <div className="font-pop bg-gray-200">
                <section className='hero relative bg-cover bg-center h-screen flex items-center justify-center shadow-xl' style={{ backgroundImage: `url(${homepageCover})` }}>
                    <div className="bg-slate-100 opacity-15 w-full h-full absolute top-0 left-0"></div>
                    <div className="popup text-center text-white p-10 lg:p-20 bg-dark backdrop-blur-md rounded-lg bg-opacity-40">
                ...
                <section className="element container mx-auto px-8 mt-12 flex flex-col items-center gap-8">
                ...
                <section className="element container px-8 mt-12 mx-auto">
                ...
                <section className=" element container px-8 py-12 mx-auto">
                ...
                <section className=" element text-white">
                    <Coupon />
                </section>
                {/* Coupons and discounts ends */}
                {/* contact us section starts */}
                <section className="element bg-gray-200">
                    <ContactUs />
                </section>
