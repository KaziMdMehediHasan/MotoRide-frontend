        ...
        <>
            ...
            <div className="bg-white text-gray-800 font-pop">
                ...
                <section className="py-12 bg-teal-600 text-white">
                    <div className="container mx-auto px-4 text-center w-2/4">
                ...
                <section className="py-12 bg-gray-100">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="mt-8">
                            <div className="timeline relative border-l-4 border-teal-500 pl-8">
                                {/* Milestone 1 */}
                                <div className="mb-8">
                                    <div className="absolute -left-3.5 top-0 w-7 h-7 rounded-full bg-teal-500"></div>
                ...
                <section className="py-12 w-full">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="mt-8 flex flex-col md:flex-row md:w-full justify-evenly items-center gap-8">
